...
namespace CDiChain.EncodingCryption.Encoder
{
    public sealed class Hex
    {
            ...
            int length)
        {
            ...
            _ = encoder.Encode(data, off, length, bOut);
            ...
            byte[] data)
        {
            ...
            _ = encoder.Decode(data, 0, data.Length, bOut);
            ...
            string data)
        {
            ...
            _ = encoder.DecodeString(data, bOut);
