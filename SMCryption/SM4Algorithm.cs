...
namespace CDiChain.EncodingCryption.SMCryption
{
    public class SM4Algorithm
    {
        ...
        private EncryptionResultTypes _encryptionResultType;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="password"></param>
        /// <param name="iv">只有CBC模式需要iv, ECB模式传null</param>
        /// <param name="encoding"></param>
        /// <param name="resultType"></param>
        public SM4Algorithm(byte[] password, byte[] iv, Encoding encoding, EncryptionResultTypes resultType)
        {
            _secretKey = password;
            _iv = iv;
            _encryptionResultType = resultType;
            _encoding = encoding;
        }

        public string EncryptString(string plaintext, SM4Models models)
        {
            switch (models)
            {
                case SM4Models.ECB:
